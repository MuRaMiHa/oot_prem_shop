...
w.fastXDM = {
  _id: 0,
  helperUrl: 'https://web.archive.org/web/20110305032337/http://userapi.com/js/api/xdmHelper.js',
...
VK.extend(VK, {
  ...
  _userStatus: 'unknown',
  _domain: {
    'main': 'https://web.archive.org/web/20110305032337/http://vkontakte.ru/',
    'api': 'https://web.archive.org/web/20110305032337/http://api.vkontakte.ru/',
    'apiPath': 'api.php'
  },
  _path: {
    login: 'login.php',
...
VK.init = function(options) {
  ...
  if (options.vk) {
    VK._domain.main = 'https://web.archive.org/web/20110305032337/http://vk.com/';
  }
  ...
  VK.Api = {
    ...
    checkMethod: function(method, params, cb, queryTry) {
      ...
      if (m == 'wall.post' || m == 'activity.set') {
        ...
        var query =  'https://web.archive.org/web/20110305032337/http://vkontakte.ru/apps.php?act=a_prepare_post&widget=1&aid='+parseInt(VK._apiId)+'&text='+encodeURIComponent(text);
        if (m == 'wall.post') {
...
VK.Auth = {
  ...
  revokeGrants: function(cb) {
    ...
    if (VK._session && VK._session.sid) VK.Api.attachScript('https://web.archive.org/web/20110305032337/http://login.vk.com/?act=openapi&aid='+parseInt(VK._apiId)+'&location=' + encodeURIComponent(window.location.hostname)+'&do_logout=1&sid='+VK._session.sid);
    VK.Cookie.clear();
  },
  ...
  getLoginStatus: function(cb, force) {
    ...
    // AttachScript here
    VK.Api.attachScript('https://web.archive.org/web/20110305032337/http://login.vk.com/?act=openapi&aid='+parseInt(VK._apiId)+'&location=' + encodeURIComponent(window.location.hostname)+'&rnd='+rnd);
  }
}
};
...
if (!VK.Widgets) {
  ...
  VK.Widgets.loading = function(obj, enabled) {
    obj.style.background = enabled ? 'url("https://web.archive.org/web/20110305032337/http://vk.com/images/upload.gif") center center no-repeat transparent' : 'none';
  }
  ...
  VK.Widgets.Comments = function(objId, options, page) {
    ...
    var res = VK.Widgets._constructor('widget_comments.php', objId, options, params, {
      showBox: function (url, props) {
        var box = VK.Util.Box((options.base_domain || 'https://web.archive.org/web/20110305032337/http://vkontakte.ru/') + url, [props.width, props.height], {
          proxy: function () {
  ...
  VK.Widgets._constructor = function(widgetUrl, objId, options, params, funcs, defaults) {
    ...
    defaults = defaults || {};
    funcs = funcs || {};
    var base_domain = options.base_domain || 'https://web.archive.org/web/20110305032337/http://vkontakte.ru';
...
VK.Util = {
  ...
  Box: function (src, sizes, fnc, options) {
    ...
    iframe = rpc.append(document.body, {
      ...
      scrolling: 'no',
      allowTransparency: true,
      style: {position: 'absolute', left: '50%', zIndex: 1002, background: 'https://web.archive.org/web/20110305032337/http://vkontakte.ru/images/upload.gif center center no-repeat transparent', padding: '0', border: '0', width: sizes[0] + 'px', height: sizes[1] + 'px', overflow: 'hidden'}
    }),
...
/*
     FILE ARCHIVED ON 03:23:37 Mar 05, 2011 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 15:54:28 Sep 30, 2021.
...
/*
playback timings (ms):
  captures_list: 670.241
  exclusion.robots: 0.091
  exclusion.robots.policy: 0.083
  RedisCDXSource: 1.689
  esindex: 0.009
  LoadShardBlock: 540.864 (3)
  PetaboxLoader3.datanode: 590.467 (4)
  CDXLines.iter: 35.351 (3)
  load_resource: 1114.159
  PetaboxLoader3.resolve: 905.675
*/